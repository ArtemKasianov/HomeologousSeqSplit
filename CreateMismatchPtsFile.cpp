...
int main(int argc, char* argv[])
{
    ...
    std::string fileNameMismatchPts = argv[6];
    double minWeightRatio = atof(argv[7]);
    unsigned minCov = atoi(argv[8]);
    unsigned maxCov = atoi(argv[9]);
    ...
    samMap.CreateMismatchPtsFile(fileNameMismatchPts,minWeightRatio,minCov,maxCov);
